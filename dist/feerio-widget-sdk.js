(function () {
    ...
    ***************************************************************************** */
    ...
    function isElementOutsideTopViewport(element) {
    ...
    const Image = React.forwardRef(({ attributes, children, element, }, ref) => {
        return (jsxRuntimeExports.jsxs("div", Object.assign({}, attributes, { children: [children, jsxRuntimeExports.jsx("div", Object.assign({ className: styles$5.imageContainer, contentEditable: false }, { children: jsxRuntimeExports.jsx("img", { src: element.url, alt: "changelog", className: styles$5.image }) }))] })));
    });
    const Element$1 = ({ attributes, children, element, }) => {
        const style = { textAlign: element.align };
        switch (element.type) {
            case "block-quote":
                return (jsxRuntimeExports.jsx("blockquote", Object.assign({ className: styles$5.blockquote, style: style }, attributes, { children: children })));
            case "heading-one":
                return (jsxRuntimeExports.jsx("h1", Object.assign({ className: styles$5.heading, style: style }, attributes, { children: children })));
            case "list-item":
                return (jsxRuntimeExports.jsx("li", Object.assign({ style: style }, attributes, { children: children })));
            case "numbered-list":
                return (jsxRuntimeExports.jsx("ol", Object.assign({ className: styles$5.orderedList, style: style }, attributes, { children: children })));
            case "bulleted-list":
                return (jsxRuntimeExports.jsx("ul", Object.assign({ className: styles$5.unorderedList, style: style }, attributes, { children: children })));
            case "image":
    ...
    const ChangelogWidget = ({ title, workspaceId, workspaceSubdomain, theme = "light", isPopUp = false, }) => {
        ...
        return (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles$6.changelogWidget} ${theme === "light" ? styles$6.light : ""}`, style: {
                border: isPopUp
                    ? "none"
                    : theme === "light"
                        ? "1px solid #e0e0e0"
                ...
                borderRadius: !isPopUp ? "4px" : "0",
            } }, { children: [!isPopUp && (jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$6.title }, { children: [jsxRuntimeExports.jsx("div", Object.assign({ className: `${styles$6.backButton} ${showingDetails ? styles$6.visible : ""}`, onClick: (e) => {
                                e.preventDefault();
                                e.stopPropagation();
                                setShowingDetails(false);
                                setTimeout(() => setSelectedChangeLog(null), 300); // Wait for animation to finish
                            ...
                            : selectedChangeLog && (selectedChangeLog === null || selectedChangeLog === void 0 ? void 0 : selectedChangeLog.title.length) > 28
                                ...
                                : selectedChangeLog === null || selectedChangeLog === void 0 ? void 0 : selectedChangeLog.title, jsxRuntimeExports.jsx("div", Object.assign({ className: `${styles$6.closeButton}`, id: "fcb-sdk" }, { children: jsxRuntimeExports.jsx(RxCross2, { size: 22 }) }))] }))), jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles$6.detailsContainer} ${theme === "light" ? "thin-scrollbar" : "thin-scrollbar-dark"}` }, { children: [fetching && jsxRuntimeExports.jsx("div", Object.assign({ className: styles$6.noData }, { children: "Loading..." })), changelogLists.length === 0 && !fetching && (jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$6.noData, style: {
                                paddingTop: "20px",
                            } }, { children: [jsxRuntimeExports.jsx(RiMapLine, { size: 18, className: "" }), "No data found. Please check back later."] }))), (changelogLists === null || changelogLists === void 0 ? void 0 : changelogLists.length) > 0 && (jsxRuntimeExports.jsx("div", Object.assign({ className: `${styles$6.changelogList} ${showingDetails ? styles$6.slideOut : ""} ${theme === "light" ? "thin-scrollbar" : "thin-scrollbar-dark"}` }, { children: jsxRuntimeExports.jsx("div", Object.assign({ className: `${styles$6.changelogList} ${theme === "light" ? "thin-scrollbar" : "thin-scrollbar-dark"}` }, { children: changelogLists &&
                                    changelogLists.map((changelog, index) => (jsxRuntimeExports.jsx("div", Object.assign({ className: styles$6.changelogItem, onClick: (e) => {
                                            e.preventDefault();
                                            e.stopPropagation();
                                            setSelectedChangeLog(changelog);
                                            setShowingDetails(true);
                                        } }, { children: jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$6.changelogContent }, { children: [jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$6.changelogTitle }, { children: [changelog.tags.length > 0 && (jsxRuntimeExports.jsx("div", Object.assign({ className: styles$6.changelogLabels }, { children: changelog.tags.map((tag, index) => (jsxRuntimeExports.jsx("div", Object.assign({ className: styles$6.label, style: {
    ...
    var css_248z$4 = ".TabComponent-module_tabs__vhImD {\r\n  --bg-color: #191919;\r\n  --text-color: #ffffff;\r\n  --border-color: #333;\r\n  --hover-bg: rgba(192, 192, 192, 0.068);\r\n  --active-color: #10b981;\r\n\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  border-bottom: 1px solid var(--border-color);\r\n  background-color: var(--bg-color);\r\n  font-family: \"Poppins\", sans-serif !important;\r\n  transition: all 0.1s ease;\r\n}\r\n\r\n.TabComponent-module_tabs__vhImD.TabComponent-module_light__-BV-J {\r\n  --bg-color: #ffffff;\r\n  --text-color: #333333;\r\n  --border-color: #e0e0e0;\r\n  --hover-bg: rgba(27, 24, 24, 0.068);\r\n  --active-color: #0a6847;\r\n}\r\n\r\n.TabComponent-module_tabContainer__D3X1X {\r\n  display: flex;\r\n  width: 100%;\r\n}\r\n\r\n.TabComponent-module_tabButton__Mouzr {\r\n  flex: 1;\r\n  padding: 0.75rem;\r\n  background-color: transparent;\r\n  border: none;\r\n  cursor: pointer;\r\n  font-size: 0.875rem;\r\n  font-weight: 500;\r\n  color: var(--text-color);\r\n  transition: all 0.1s ease;\r\n  font-family: \"Poppins\", sans-serif !important;\r\n  font-size: 14px !important;\r\n}\r\n\r\n.TabComponent-module_tabButton__Mouzr:hover {\r\n  background-color: var(--hover-bg);\r\n}\r\n\r\n.TabComponent-module_tabButton__Mouzr.TabComponent-module_active__efR1P {\r\n  color: var(--active-color);\r\n  border-bottom: 2px solid var(--active-color);\r\n}\r\n\r\n.TabComponent-module_closeButton__GEnLq {\r\n  display: none;\r\n  color: var(--text-color);\r\n  background: none;\r\n  border: none;\r\n  cursor: pointer;\r\n  padding: 0.75rem;\r\n  transition: color 0.1s ease;\r\n}\r\n\r\n.TabComponent-module_closeButton__GEnLq:hover {\r\n  color: var(--active-color);\r\n}\r\n\r\n@media (max-width: 480px) {\r\n  .TabComponent-module_closeButton__GEnLq {\r\n    display: block;\r\n  }\r\n}\r\n";
    var styles$4 = {"tabs":"TabComponent-module_tabs__vhImD","light":"TabComponent-module_light__-BV-J","tabContainer":"TabComponent-module_tabContainer__D3X1X","tabButton":"TabComponent-module_tabButton__Mouzr","active":"TabComponent-module_active__efR1P","closeButton":"TabComponent-module_closeButton__GEnLq"};
    styleInject(css_248z$4);

    const TabComponent = ({ activeTab, setActiveTab, onClose, color, theme = "light", }) => {
        return (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles$4.tabs} ${styles$4[theme]}` }, { children: [jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$4.tabContainer }, { children: [jsxRuntimeExports.jsx("button", Object.assign({ className: `${styles$4.tabButton} ${activeTab === "changelogs" ? styles$4.active : ""}`, style: {
                                color: activeTab === "changelogs" ? color : "",
                                borderColor: activeTab === "changelogs" ? color : "",
                            }, onClick: () => setActiveTab("changelogs") }, { children: "Changelogs" })), jsxRuntimeExports.jsx("button", Object.assign({ className: `${styles$4.tabButton} ${activeTab === "feedback" ? styles$4.active : ""}`, style: {
                                color: activeTab === "feedback" ? color : "",
                                borderColor: activeTab === "feedback" ? color : "",
                            }, onClick: () => setActiveTab("feedback") }, { children: "Feedback" }))] })), jsxRuntimeExports.jsx("div", Object.assign({ className: styles$4.closeButton, onClick: onClose }, { children: jsxRuntimeExports.jsx(RxCross2, { size: 22 }) }))] })));
    };

    var css_248z$3 = ".ChangelogWidgetPopUp-module_changelogWrapper__A5wtw {\r\n  --bg-color-light: #ffffff;\r\n  --border-color-light: #e0e0e0;\r\n  --bg-color-dark: #191919;\r\n  --border-color-dark: #333;\r\n}\r\n\r\n#ChangelogWidgetPopUp-module_changelog-widget-portal-fc__056dj {\r\n  position: fixed !important;\r\n  bottom: 1rem !important;\r\n  right: 1rem !important;\r\n  z-index: 9999 !important;\r\n}\r\n.ChangelogWidgetPopUp-module_container__VdtES {\r\n  position: relative;\r\n}\r\n\r\n.ChangelogWidgetPopUp-module_button__i8O2R {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  width: 3.5rem;\r\n  height: 3.5rem;\r\n  border-radius: 9999px;\r\n  cursor: pointer;\r\n  outline: none;\r\n  border: none;\r\n  transition: all 0.3s ease-in-out;\r\n}\r\n.ChangelogWidgetPopUp-module_button__i8O2R:hover {\r\n  opacity: 0.8;\r\n}\r\n.ChangelogWidgetPopUp-module_attachedButton__huR4w {\r\n  font-family: \"Poppins\", sans-serif !important;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  gap: 0.5rem;\r\n  width: 38px !important;\r\n  /* cursor: pointer; */\r\n  outline: none;\r\n  transition: all 0.3s ease-in-out;\r\n  writing-mode: vertical-rl;\r\n  text-orientation: mixed;\r\n  border: var(--border-color-light);\r\n  transform: rotate(180deg);\r\n  font-size: 13px !important;\r\n  letter-spacing: 0.2px !important;\r\n  font-weight: 400 !important;\r\n}\r\n\r\n.ChangelogWidgetPopUp-module_dark__jpGyd.ChangelogWidgetPopUp-module_attachedButton__huR4w {\r\n  border: var(--border-color-dark);\r\n}\r\n\r\n.ChangelogWidgetPopUp-module_icon__VM24a {\r\n  color: white;\r\n}\r\n\r\n.ChangelogWidgetPopUp-module_widgetContainer__rtwtZ {\r\n  position: absolute;\r\n  /* bottom: 4.5rem; */\r\n  /* right: 0; */\r\n  /* left: 0; */\r\n  min-width: 300px;\r\n  width: 330px;\r\n  /* this is 420 - 48px for the title div of the changelog widget */\r\n  background-color: var(--bg-color-light);\r\n  border-radius: 4px;\r\n  box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);\r\n  overflow: hidden;\r\n  display: flex;\r\n  flex-direction: column;\r\n  animation: ChangelogWidgetPopUp-module_fadeUp__TnpEx 0.3s ease;\r\n  transition: all 0.1s ease;\r\n  border: 1px solid var(--border-color-light);\r\n}\r\n\r\n.ChangelogWidgetPopUp-module_dark__jpGyd.ChangelogWidgetPopUp-module_widgetContainer__rtwtZ {\r\n  background-color: var(--bg-color-dark);\r\n  border: 1px solid var(--border-color-dark);\r\n}\r\n\r\n.ChangelogWidgetPopUp-module_contentContainer__lwav8 {\r\n  flex-grow: 1;\r\n  overflow-y: auto;\r\n  height: 372px;\r\n  /* this is 420 - 48px for the title div of the changelog widget */\r\n}\r\n\r\n.ChangelogWidgetPopUp-module_feedbackPlaceholder__i1nLL {\r\n  padding: 1rem;\r\n  text-align: center;\r\n  color: #666;\r\n}\r\n\r\n/* ----animation */\r\n@keyframes ChangelogWidgetPopUp-module_fadeUp__TnpEx {\r\n  from {\r\n    opacity: 0;\r\n    transform: translateY(20px);\r\n  }\r\n  to {\r\n    opacity: 1;\r\n    transform: translateY(0);\r\n  }\r\n}\r\n\r\n/* add media query for mobile to take the full width  and height of the screen */\r\n\r\n@media (max-width: 480px) {\r\n  .ChangelogWidgetPopUp-module_widgetContainer__rtwtZ {\r\n    width: 100vw !important;\r\n    height: 100vh !important;\r\n    border-radius: 0;\r\n    bottom: -16px !important;\r\n    right: -16px !important;\r\n  }\r\n}\r\n";
    var styles$3 = {"changelogWrapper":"ChangelogWidgetPopUp-module_changelogWrapper__A5wtw","changelog-widget-portal-fc":"ChangelogWidgetPopUp-module_changelog-widget-portal-fc__056dj","container":"ChangelogWidgetPopUp-module_container__VdtES","button":"ChangelogWidgetPopUp-module_button__i8O2R","attachedButton":"ChangelogWidgetPopUp-module_attachedButton__huR4w","dark":"ChangelogWidgetPopUp-module_dark__jpGyd","icon":"ChangelogWidgetPopUp-module_icon__VM24a","widgetContainer":"ChangelogWidgetPopUp-module_widgetContainer__rtwtZ","fadeUp":"ChangelogWidgetPopUp-module_fadeUp__TnpEx","contentContainer":"ChangelogWidgetPopUp-module_contentContainer__lwav8","feedbackPlaceholder":"ChangelogWidgetPopUp-module_feedbackPlaceholder__i1nLL"};
    ...
    const FileUploadButton = ({ onFileSelect, disabled = false, acceptedFileTypes = ".png,.jpeg,.jpg", currentFileSize = 0, maxFileSize = 3, showSizeInfo = false, }) => {
        const fileInputRef = reactExports.useRef(null);
        const handleButtonClick = reactExports.useCallback((event) => {
            var _a;
            event.preventDefault();
            if (disabled) {
        ...
        const handleFileChange = reactExports.useCallback((event) => {
            var _a;
            const file = (_a = event.target.files) === null || _a === void 0 ? void 0 : _a[0];
            const newFileSizeInMB = ((file === null || file === void 0 ? void 0 : file.size) || 0) / (1024 * 1024);
        ...
        return (jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$1.container }, { children: [jsxRuntimeExports.jsx("button", Object.assign({ className: `${styles$1.button} ${disabled ? styles$1.disabled : ""}`, onClick: handleButtonClick, disabled: disabled, "aria-label": "Attach file", title: "Attach file" }, { children: jsxRuntimeExports.jsx(MdAttachFile, { size: 20, style: {
                            transform: "rotate(45deg)",
                            outline: "none",
                        } }) })), showSizeInfo && currentFileSize > 0 && (jsxRuntimeExports.jsxs("span", Object.assign({ className: styles$1.sizeInfo }, { children: [currentFileSize.toFixed(2), "MB / ", maxFileSize, "MB"] }))), jsxRuntimeExports.jsx("input", { type: "file", accept: acceptedFileTypes, ref: fileInputRef, className: styles$1.input, onChange: handleFileChange, "aria-hidden": "true" })] })));
    };

    var css_248z = ".ImagePreviewGrid-module_container__LovcK {\r\n  display: flex;\r\n  gap: 24px;\r\n  align-items: flex-start;\r\n  flex-wrap: wrap;\r\n  padding: 4px;\r\n  border-radius: 6px;\r\n  margin-right: 20px;\r\n}\r\n\r\n.ImagePreviewGrid-module_imageWrapper__C5OBy {\r\n  position: relative;\r\n  display: inline-block;\r\n}\r\n\r\n.ImagePreviewGrid-module_image__lDhT5 {\r\n  max-height: 80px;\r\n  object-fit: cover;\r\n  border-radius: 6px;\r\n  box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);\r\n}\r\n\r\n.ImagePreviewGrid-module_removeButton__9zIAT {\r\n  position: absolute;\r\n  top: -8px;\r\n  right: -8px;\r\n  border-radius: 100%;\r\n  background-color: var(--bg-color-light);\r\n  border: none;\r\n  padding: 0px;\r\n  cursor: pointer;\r\n  color: #860000;\r\n  transition: color 0.2s ease;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n}\r\n\r\n.ImagePreviewGrid-module_closeIcon__7y-St {\r\n  fill: currentColor;\r\n}\r\n";
    var styles = {"container":"ImagePreviewGrid-module_container__LovcK","imageWrapper":"ImagePreviewGrid-module_imageWrapper__C5OBy","image":"ImagePreviewGrid-module_image__lDhT5","removeButton":"ImagePreviewGrid-module_removeButton__9zIAT","closeIcon":"ImagePreviewGrid-module_closeIcon__7y-St"};
    styleInject(css_248z);

    const ImagePreviewGrid = ({ attachedImages, setAttachedImages, }) => {
        ...
        if (attachedImages.length === 0)
            return null;
        return (jsxRuntimeExports.jsx("div", Object.assign({ className: styles.container }, { children: attachedImages.map((image, index) => (jsxRuntimeExports.jsxs("div", Object.assign({ className: styles.imageWrapper }, { children: [jsxRuntimeExports.jsx("img", { src: getImageSrc(image), alt: `Preview ${index + 1}`, className: styles.image }), jsxRuntimeExports.jsx("button", Object.assign({ onClick: (e) => {
                            e.stopPropagation();
                            handleRemoveImage(image);
                        }, className: styles.removeButton, "aria-label": "Remove image" }, { children: jsxRuntimeExports.jsx(IoCloseCircle, { size: 20 }) }))] }), index))) })));
    };

    const FeedbackComponent = ({ workspaceId, color, theme = "light", user, }) => {
        ...
        const [attachedImages, setAttachedImages] = reactExports.useState([]);
        const [addingPost, setAddingPost] = reactExports.useState(false);
        const [message, setMessage] = reactExports.useState({
            type: "",
            content: "",
        });
        const addPost = reactExports.useCallback(({ title, description, showInputDetails, workspaceId, attachedImages, }) => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            try {
                if (!title) {
                ...
                setAddingPost(true);
                let response;
                if (attachedImages === null || attachedImages === void 0 ? void 0 : attachedImages.length) {
                    ...
                    response = yield axios$1.post(`${BASE_URL}/sdk/add-post-sdk`, formData, {
                        headers: { "Content-Type": "multipart/form-data" },
                    });
                }
                else {
                    response = yield axios$1.post(`${BASE_URL}/sdk/add-post-sdk`, postData);
                }
                const { data } = response;
                if (!data.success)
        ...
        }), [user === null || user === void 0 ? void 0 : user.email, user === null || user === void 0 ? void 0 : user.name]);
        const createPostComponent = () => {
            return (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles$2[theme]} ${styles$2.postContainer} ` }, { children: [jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$2.header }, { children: [jsxRuntimeExports.jsx("div", Object.assign({ className: styles$2.backButton, onClick: (e) => {
                                    e.preventDefault();
                                    e.stopPropagation();
                                    setShowInputDetails({
                                        show: false,
                                ...
                                } }, { children: jsxRuntimeExports.jsx(HiOutlineArrowNarrowLeft, { size: 20 }) })), jsxRuntimeExports.jsx("h3", { children: showInputDetails.boardTitle || "Request a feature" })] })), jsxRuntimeExports.jsx("input", { type: "text", placeholder: "Your post title..", className: styles$2.postInput, value: title, 
                        // autoFocus
                        onChange: (e) => setTitle(e.target.value), onFocus: (e) => {
                            e.target.style.borderColor = color;
                            setMessage({ type: "", content: "" });
                        }, onBlur: (e) => (e.target.style.borderColor =
                            theme === "light" ? "#d1d5db" : "#1f2937") }), jsxRuntimeExports.jsx("textarea", { placeholder: "Add a brief description..", className: styles$2.postTextArea, value: description, onChange: (e) => setDescription(e.target.value), onFocus: (e) => {
                            e.target.style.borderColor = color;
                            setMessage({ type: "", content: "" });
                        }, onBlur: (e) => (e.target.style.borderColor =
                            theme === "light" ? "#d1d5db" : "#1f2937") }), jsxRuntimeExports.jsx(ImagePreviewGrid, { attachedImages: attachedImages, setAttachedImages: setAttachedImages }), jsxRuntimeExports.jsxs("div", Object.assign({ style: {
                            display: "flex",
                            justifyContent: "space-between",
                            alignItems: "center",
                            gap: "6px",
                        } }, { children: [jsxRuntimeExports.jsx(FileUploadButton, { onFileSelect: (file) => {
                                    setAttachedImages((prev) => [...prev, file]);
                                }, disabled: addingPost, currentFileSize: attachedImages.reduce((acc, file) => acc + file.size, 0) /
                                    (1024 * 1024), maxFileSize: 3, showSizeInfo: false }), jsxRuntimeExports.jsx("button", Object.assign({ className: styles$2.postButton, style: {
                                    ...
                                    workspaceId,
                                    attachedImages,
                                }) }, { children: addingPost ? "Saving..." : "Submit Feedback" }))] })), message.content && message.type && (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles$2.message} ${styles$2[message.type]}` }, { children: [message.type === "success" ? (jsxRuntimeExports.jsx(FaCheck, { size: 18, className: styles$2.messageIcon })) : (jsxRuntimeExports.jsx(IoWarningOutline, { className: styles$2.messageIcon })), jsxRuntimeExports.jsxs("p", { children: [message.content, " ", message.postUrl && (jsxRuntimeExports.jsx("a", Object.assign({ href: `https://${message.postUrl}`, className: styles$2.viewPost, target: "_blank", rel: "noreferrer" }, { children: "View Post" }))), " "] })] })))] })));
        };
        return (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles$2[theme]} ${styles$2.feedbackWrapper} ${styles$2.container} animateFadeUp ` }, { children: [!showInputDetails.show && boards && (boards === null || boards === void 0 ? void 0 : boards.length) > 0 && (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: boards === null || boards === void 0 ? void 0 : boards.map((board) => (jsxRuntimeExports.jsx("div", Object.assign({ className: styles$2.feedbackButton, onClick: () => {
                            setShowInputDetails({
                                show: true,
                        ...
                        } }, { children: jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$2.buttonContent }, { children: [jsxRuntimeExports.jsx("p", Object.assign({ className: `${styles$2.boardTitle}` }, { children: board.name })), jsxRuntimeExports.jsx("p", Object.assign({ className: `${styles$2.boardDescription}` }, { children: board.description || "What request you got ?" }))] })) }), board.boardId))) })), showInputDetails.show && createPostComponent(), !loading && !(boards === null || boards === void 0 ? void 0 : boards.length) && (jsxRuntimeExports.jsx("h3", Object.assign({ style: {
                        textAlign: "center",
                        fontSize: "12px",
                        fontWeight: 400,
                    } }, { children: "No feedback boards found!" }))), loading && (jsxRuntimeExports.jsx("p", Object.assign({ style: {
                        textAlign: "center",
                        fontSize: "12px",
                        fontWeight: 400,
                    } }, { children: "Loading..." })))] })));
    ...
    const ChangelogWidgetPopUp = ({ workspaceId, workspaceSubdomain, theme = "light", color = "#0A6847", position = "right", showChangelog = true, user, initializerStyle = "popup", attachedButtonStyles, onUnmount, }) => {
        const [showWidget, setShowWidget] = reactExports.useState(false);
        const [activeTab, setActiveTab] = reactExports.useState(showChangelog ? "changelogs" : "feedback");
        ...
        const startPositionY = reactExports.useRef(0);
        ...
        //   };
        // }, []);
        attachedButtonStyles = Object.assign(Object.assign({}, attachedButtonStyles), { backgroundColor: (attachedButtonStyles === null || attachedButtonStyles === void 0 ? void 0 : attachedButtonStyles.backgroundColor) ||
                (theme === "dark" ? "#333" : "#fffaf3"), color: (attachedButtonStyles === null || attachedButtonStyles === void 0 ? void 0 : attachedButtonStyles.color) || (theme === "dark" ? "#fff" : "#0A6847"), label: (attachedButtonStyles === null || attachedButtonStyles === void 0 ? void 0 : attachedButtonStyles.label) || "Feedback" });
        const updatePosition = reactExports.useCallback((clientY) => {
            ...
            const newPosition = Math.max(7, Math.min(93, startPositionY.current + deltaPercent));
            portal.style.top = `${newPosition}%`;
            portal.style.transform = "translateY(-50%)";
        }, [isDragging]);
        // Handle drag start for mouse events
        const handleMouseStart = reactExports.useCallback((e) => {
            if (initializerStyle !== "attached")
                return;
            e.preventDefault();
            e.stopPropagation();
            const portal = document.getElementById("changelog-widget-portal-fc");
        ...
        const getWidgetPosition = reactExports.useCallback(() => {
            ...
            if (!initializerElement)
                return {};
            const { outsideTop, isMobile } = isElementOutsideTopViewport(initializerElement);
            if (isMobile) {
        ...
        return (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles$3.container} ${styles$3.changelogWrapper} ` }, { children: [initializerStyle === "popup" ? (jsxRuntimeExports.jsx("button", Object.assign({ onClick: () => setShowWidget(!showWidget), ref: initializerRef, className: `${styles$3.button} animateFadeIn`, style: {
                        backgroundColor: color || "#0A6847",
                    }, "aria-label": showWidget ? "Close Widget" : "Open Widget" }, { children: showWidget ? (jsxRuntimeExports.jsx(MdClose, { size: 24, className: `${styles$3.icon} animateFadeIn` })) : (jsxRuntimeExports.jsx(FaRegLightbulb, { size: 24, className: `${styles$3.icon} animateFadeIn` })) }))) : (jsxRuntimeExports.jsx("button", Object.assign({ onClick: (e) => {
                        e.stopPropagation();
                        e.preventDefault();
                        setShowWidget(!showWidget);
                    }, onMouseDown: handleMouseStart, onTouchStart: handleTouchStart, ref: initializerRef, className: ` ${styles$3.attachedButton} animateFadeIn`, style: {
                    ...
                    }, "aria-label": showWidget ? "Close Widget" : "Open Widget" }, { children: attachedButtonStyles.label }))), showWidget && (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles$3[theme]} ${styles$3.widgetContainer}`, style: getWidgetPosition(), ref: widgetRef }, { children: [showChangelog && (jsxRuntimeExports.jsx(TabComponent, { onClose: () => setShowWidget(false), activeTab: activeTab, setActiveTab: setActiveTab, color: color, theme: theme })), jsxRuntimeExports.jsx("div", Object.assign({ className: `${styles$3.contentContainer} ${theme === "light" ? "thin-scrollbar" : "thin-scrollbar-dark"}` }, { children: activeTab === "changelogs" ? (jsxRuntimeExports.jsx(ChangelogWidget, { title: "Changelog", workspaceId: workspaceId, workspaceSubdomain: workspaceSubdomain, theme: theme, isPopUp: true })) : (jsxRuntimeExports.jsx(FeedbackComponent, { workspaceId: workspaceId, color: color, theme: theme, user: user })) }))] })))] })));
    };
        ...
        resetUser(newUser) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    yield this.cleanupExistingWidget();
                ...
                return new Promise((resolve) => {
                    ...
                    if (portal) {
                        try {
                            ...
                            (_a = portal.parentNode) === null || _a === void 0 ? void 0 : _a.replaceChild(clone, portal);
    ...
    const renderChangelogWidgetPopup = ({ theme, workspaceId, workspaceSubdomain, color, position, showChangelog, absolutePosition, user, initializerStyle = "popup", attachedButtonStyles, }) => {
        ...
        if (initializerStyle === "popup") {
            ...
            portalContainer.style.bottom = (absolutePosition === null || absolutePosition === void 0 ? void 0 : absolutePosition.bottom) || "1rem";
            if (position === "left") {
                portalContainer.style.left = (absolutePosition === null || absolutePosition === void 0 ? void 0 : absolutePosition.left) || "1rem";
            }
            else {
                portalContainer.style.right = (absolutePosition === null || absolutePosition === void 0 ? void 0 : absolutePosition.right) || "1rem";
            }
        }
    ...
    translateY(-50%)`;
        ...
        ReactDOM.render(jsxRuntimeExports.jsx(ChangelogWidgetPopUp, { workspaceId: workspaceId, workspaceSubdomain: workspaceSubdomain, theme: theme, color: color, position: position, showChangelog: showChangelog, user: user, initializerStyle: initializerStyle, attachedButtonStyles: attachedButtonStyles, onUnmount: () => manager.trackUnmount("changelog-widget-portal-fc") }), portalContainer);
    };
    ...
    const generateIframeComponent = (options) => {
        ...
        const baseUrl = `${"http:" }//${encodeURIComponent(workspaceSubdomain)}${PLAIN_DOMAIN_URL}/widgets/public-board`;
    ...
    */
    ...
    const resetUser = (newUser) => __awaiter(void 0, void 0, void 0, function* () {
        console.log("====RESETTING USER IN CHANGELOG POPUP====");
        const manager = WidgetManager.getInstance();
        const success = yield manager.resetUser(newUser);
        if (success) {
