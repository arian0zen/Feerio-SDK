(function () {
	...
	***************************************************************************** */
	...
	var css_248z$2 = ".TabComponent-module_tabs__vhImD {\r\n  --bg-color: #191919;\r\n  --text-color: #ffffff;\r\n  --border-color: #333;\r\n  --hover-bg: rgba(192, 192, 192, 0.068);\r\n  --active-color: #10b981;\r\n\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  border-bottom: 1px solid var(--border-color);\r\n  background-color: var(--bg-color);\r\n  font-family: \"Poppins\", sans-serif !important;\r\n  transition: all 0.1s ease;\r\n}\r\n\r\n.TabComponent-module_tabs__vhImD.TabComponent-module_light__-BV-J {\r\n  --bg-color: #ffffff;\r\n  --text-color: #333333;\r\n  --border-color: #e0e0e0;\r\n  --hover-bg: rgba(27, 24, 24, 0.068);\r\n  --active-color: #0a6847;\r\n}\r\n\r\n.TabComponent-module_tabContainer__D3X1X {\r\n  display: flex;\r\n  width: 100%;\r\n}\r\n\r\n.TabComponent-module_tabButton__Mouzr {\r\n  flex: 1;\r\n  padding: 0.75rem;\r\n  background-color: transparent;\r\n  border: none;\r\n  cursor: pointer;\r\n  font-size: 0.875rem;\r\n  font-weight: 500;\r\n  color: var(--text-color);\r\n  transition: all 0.1s ease;\r\n  font-family: \"Poppins\", sans-serif !important;\r\n  font-size: 14px !important;\r\n}\r\n\r\n.TabComponent-module_tabButton__Mouzr:hover {\r\n  background-color: var(--hover-bg);\r\n}\r\n\r\n.TabComponent-module_tabButton__Mouzr.TabComponent-module_active__efR1P {\r\n  color: var(--active-color);\r\n  border-bottom: 2px solid var(--active-color);\r\n}\r\n\r\n.TabComponent-module_closeButton__GEnLq {\r\n  display: none;\r\n  color: var(--text-color);\r\n  background: none;\r\n  border: none;\r\n  cursor: pointer;\r\n  padding: 0.75rem;\r\n  transition: color 0.1s ease;\r\n}\r\n\r\n.TabComponent-module_closeButton__GEnLq:hover {\r\n  color: var(--active-color);\r\n}\r\n\r\n@media (max-width: 480px) {\r\n  .TabComponent-module_closeButton__GEnLq {\r\n    display: block;\r\n  }\r\n}\r\n";
	var styles$2 = {"tabs":"TabComponent-module_tabs__vhImD","light":"TabComponent-module_light__-BV-J","tabContainer":"TabComponent-module_tabContainer__D3X1X","tabButton":"TabComponent-module_tabButton__Mouzr","active":"TabComponent-module_active__efR1P","closeButton":"TabComponent-module_closeButton__GEnLq"};
	styleInject(css_248z$2);

	const TabComponent = ({ activeTab, setActiveTab, onClose, color, theme = "light", }) => {
	    return (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles$2.tabs} ${styles$2[theme]}` }, { children: [jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$2.tabContainer }, { children: [jsxRuntimeExports.jsx("button", Object.assign({ className: `${styles$2.tabButton} ${activeTab === "changelogs" ? styles$2.active : ""}`, style: {
	                            color: activeTab === "changelogs" ? color : "",
	                            borderColor: activeTab === "changelogs" ? color : "",
	                        }, onClick: () => setActiveTab("changelogs") }, { children: "Changelogs" })), jsxRuntimeExports.jsx("button", Object.assign({ className: `${styles$2.tabButton} ${activeTab === "feedback" ? styles$2.active : ""}`, style: {
	...
	const FeedbackComponent = ({ workspaceId, color, theme = "light", user, }) => {
	    ...
	    const createPostComponent = () => {
	        return (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles[theme]} ${styles.postContainer} ` }, { children: [jsxRuntimeExports.jsxs("div", Object.assign({ className: styles.header }, { children: [jsxRuntimeExports.jsx("div", Object.assign({ className: styles.backButton, onClick: (e) => {
	                                e.preventDefault();
	                                e.stopPropagation();
	                                setShowInputDetails({
	                                    show: false,
	                            ...
	                            } }, { children: jsxRuntimeExports.jsx(HiOutlineArrowNarrowLeft, { size: 20 }) })), jsxRuntimeExports.jsx("h3", { children: showInputDetails.boardTitle || "Request a feature" })] })), jsxRuntimeExports.jsx("input", { type: "text", placeholder: "Your post title..", className: styles.postInput, value: title, 
	                    // autoFocus
	                    onChange: (e) => setTitle(e.target.value), onFocus: (e) => {
	                        e.target.style.borderColor = color;
	                        setMessage({ type: "", content: "" });
	                    }, onBlur: (e) => (e.target.style.borderColor =
	                        theme === "light" ? "#d1d5db" : "#1f2937") }), jsxRuntimeExports.jsx("textarea", { placeholder: "Add a brief description..", className: styles.postTextArea, value: description, onChange: (e) => setDescription(e.target.value), onFocus: (e) => {
	                        e.target.style.borderColor = color;
	                        setMessage({ type: "", content: "" });
	                    }, onBlur: (e) => (e.target.style.borderColor =
	...
	const ChangelogWidgetPopUp = ({ workspaceId, workspaceSubdomain, theme = "light", color = "#0A6847", position = "right", showChangelog = true, user, initializerStyle = "popup", attachedButtonStyles, }) => {
	    ...
	    return (jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$1.container }, { children: [initializerStyle === "popup" ? (jsxRuntimeExports.jsx("button", Object.assign({ onClick: () => setShowWidget(!showWidget), ref: initializerRef, className: `${styles$1.button} animateFadeIn`, style: {
	                    backgroundColor: color || "#0A6847",
	                }, "aria-label": showWidget ? "Close Widget" : "Open Widget" }, { children: showWidget ? (jsxRuntimeExports.jsx(MdClose, { size: 24, className: `${styles$1.icon} animateFadeIn` })) : (jsxRuntimeExports.jsx(FaRegLightbulb, { size: 24, className: `${styles$1.icon} animateFadeIn` })) }))) : (jsxRuntimeExports.jsx("button", Object.assign({ onClick: (e) => {
	                    e.stopPropagation();
	                    e.preventDefault();
	                    setShowWidget(!showWidget);
	                }, onMouseDown: handleMouseStart, onTouchStart: handleTouchStart, ref: initializerRef, className: ` ${styles$1.attachedButton} animateFadeIn`, style: {
