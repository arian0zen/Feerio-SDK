(function () {
	...
	***************************************************************************** */
	...
	const FeedbackComponent = ({ workspaceId, color, theme = "light", }) => {
	    ...
	    return (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles[theme]} ${styles.container} animateFadeUp ` }, { children: [!showInputDetails.show &&
	                boards &&
