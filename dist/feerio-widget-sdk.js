	...
	***************************************************************************** */
	...
	const FeedbackComponent = ({ workspaceId, color, theme = "light", user, }) => {
	    ...
	    return (jsxRuntimeExports.jsxs("div", Object.assign({ className: `${styles[theme]} ${styles.container} animateFadeUp ` }, { children: [!showInputDetails.show && boards && (boards === null || boards === void 0 ? void 0 : boards.length) > 0 && (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [boards === null || boards === void 0 ? void 0 : boards.map((board) => (jsxRuntimeExports.jsx("div", Object.assign({ className: styles.feedbackButton, onClick: () => {
	                        ...
	                        } }, { children: jsxRuntimeExports.jsxs("div", Object.assign({ className: styles.buttonContent }, { children: [jsxRuntimeExports.jsx("p", Object.assign({ className: `${styles.boardTitle}` }, { children: board.name })), jsxRuntimeExports.jsx("p", Object.assign({ className: `${styles.boardDescription}` }, { children: board.description || "What request you got ?" }))] })) }), board.boardId))), jsxRuntimeExports.jsxs("p", Object.assign({ style: {
	                            fontSize: "11px",
	                            textAlign: "center",
	                            fontWeight: 500,
	                        } }, { children: ["Collect Feedback with", " ", jsxRuntimeExports.jsx("a", Object.assign({ href: "https://feerio.com", target: "_blank", rel: "noreferrer", style: {
	                                    color: "#0A6847",
	                                    textDecoration: "none",
	                                    fontWeight: 500,
	                                } }, { children: "Feerio" }))] }))] })), showInputDetails.show && createPostComponent(), !loading && !(boards === null || boards === void 0 ? void 0 : boards.length) && (jsxRuntimeExports.jsx("h3", Object.assign({ style: {
	                    textAlign: "center",
	                    fontSize: "12px",
	                    fontWeight: 400,
	...
	const ChangelogWidgetPopUp = ({ workspaceId, workspaceSubdomain, theme = "light", color = "#0A6847", position = "right", showChangelog = true, user, }) => {
	    ...
	    return (jsxRuntimeExports.jsxs("div", Object.assign({ className: styles$1.container }, { children: [jsxRuntimeExports.jsx("button", Object.assign({ onClick: () => setShowWidget(!showWidget), ref: initializerRef, className: ` ${styles$1.button} animateFadeIn`, style: {
	                ...
	                }, ref: widgetRef }, { children: [showChangelog && (jsxRuntimeExports.jsx(TabComponent, { onClose: () => {
	                            setShowWidget(false);
	...
	const renderChangelogWidgetPopup = ({ theme, workspaceId, workspaceSubdomain, color, position, showChangelog, absolutePosition, user, }) => {
	    ...
	    ReactDOM.render(jsxRuntimeExports.jsx(ChangelogWidgetPopUp, { workspaceId: workspaceId, workspaceSubdomain: workspaceSubdomain, theme: theme, color: color, position: position, showChangelog: showChangelog, user: user }), portalContainer);
	};
